...
from marketing.models import MarketingMeeting, MeetingType, Contract
from marketing.permission import ContractApprovalPermission
...
def approve_contract(request, pk):
    try:
        ...
        contract.save()
        return Response({'status': 'Approved successful'}, status=status.HTTP_200_OK)
